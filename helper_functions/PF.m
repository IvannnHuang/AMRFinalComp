...
addpath("helper_functions\");
    ...
    % newParticles(1,:) = newParticles(1,:) + 0.01 * randn(1, numParticles);  % 1 cm noise
    % newParticles(2,:) = newParticles(2,:) + 0.01 * randn(1, numParticles);
    % newParticles(3,:) = newParticles(3,:) + deg2rad(1.0) * randn(1, numParticles);
    % newParticles(3,:) = mod(newParticles(3,:) + pi, 2*pi) - pi;
